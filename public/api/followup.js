// public/api/followup.js (Vercel Node Serverless, CommonJS + safe JSON body parsing)
  ...
  try {
    const r = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 120,
        messages: [
          { role: 'system', content: 'You are a gentle, trauma-informed coach named Sarah. Ask ONE concise, compassionate follow-up question based on the user’s response. Avoid medical advice.' },
